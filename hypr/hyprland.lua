...
-- Needed outside a full Plasma session for Qt/KDE apps to actually read
-- kdeglobals (color scheme, fonts) via plasma-integration's QPA platform theme
hl.env("QT_QPA_PLATFORMTHEME", "kde")

-- Makes QML/Qt Quick views (e.g. Dolphin's file grid) follow the desktop
-- color scheme too - without this they stay on the QML default light style
-- even though QWidget panels (sidebar etc.) correctly pick up kdeglobals
